...
public class SteamVR_Camera : MonoBehaviour
{
	...
	void OnEnable()
	{
        ...
        //lets get some values here
        Debug.Log("fieldOfView " + vr.fieldOfView);
        Debug.Log("aspect " + vr.aspect);
        Debug.Log("Tracked Device 0 = " + vr.GetTrackedDeviceString(0));
        Debug.Log("Display Frequency " + vr.hmd_DisplayFrequency);
        Debug.Log("Tracking system name = " + vr.hmd_TrackingSystemName);
        Debug.Log("Scene height = " + vr.sceneHeight);
        Debug.Log("Scene width = " + vr.sceneWidth);
        Debug.Log("TanHalfFOV = " + vr.tanHalfFov);
        Debug.Log("TB 0 uMin = " + vr.textureBounds[0].uMin);
        Debug.Log("TB 0 uMax = " + vr.textureBounds[0].uMax);
        Debug.Log("TB 0 vMin = " + vr.textureBounds[0].vMin);
        Debug.Log("TB 0 vMax = " + vr.textureBounds[0].vMax);
        Debug.Log("TB 1 uMin = " + vr.textureBounds[1].uMin);
        Debug.Log("TB 1 uMax = " + vr.textureBounds[1].uMax);
        Debug.Log("TB 1 vMin = " + vr.textureBounds[1].vMin);
        Debug.Log("TB 1 vMax = " + vr.textureBounds[1].vMax);
